...
export declare class ShipmentDocumentsResource extends BaseResource<ShipmentDocument, ShipmentDocumentAttributes, ShipmentDocumentFilters> {
    constructor(config: Omit<ResourceConfig, 'basePath' | 'resourceType'>);
}
//# sourceMappingURL=shipmentDocuments.d.ts.map